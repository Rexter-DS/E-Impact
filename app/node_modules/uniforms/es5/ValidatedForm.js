...
function Validated(Base) {
    ...
    var ValidatedForm = /** @class */ (function (_super) {
        tslib_1.__extends(ValidatedForm, _super);
        ...
        ValidatedForm.prototype.getContext = function () {
            return tslib_1.__assign(tslib_1.__assign({}, _super.prototype.getContext.call(this)), { validating: this.state.validating });
        };
        ...
        ValidatedForm.prototype.componentDidUpdate = function (prevProps, prevState, snapshot) {
            ...
            else if (!isEqual_1.default(model, prevProps.model) &&
