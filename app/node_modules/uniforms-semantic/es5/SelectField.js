...
function Select(_a) {
    var allowedValues = _a.allowedValues, checkboxes = _a.checkboxes, className = _a.className, disableItem = _a.disableItem, disabled = _a.disabled, error = _a.error, errorMessage = _a.errorMessage, fieldType = _a.fieldType, id = _a.id, inputRef = _a.inputRef, label = _a.label, name = _a.name, onChange = _a.onChange, placeholder = _a.placeholder, required = _a.required, showInlineError = _a.showInlineError, transform = _a.transform, value = _a.value, props = tslib_1.__rest(_a, ["allowedValues", "checkboxes", "className", "disableItem", "disabled", "error", "errorMessage", "fieldType", "id", "inputRef", "label", "name", "onChange", "placeholder", "required", "showInlineError", "transform", "value"]);
    return (react_1.default.createElement("div", tslib_1.__assign({ className: classnames_1.default({ disabled: disabled, error: error, required: required }, className, 'field') }, uniforms_1.filterDOMProps(props)),
        ...
        checkboxes || fieldType === Array ? (allowedValues === null || allowedValues === void 0 ? void 0 : allowedValues.map(function (item) { return (react_1.default.createElement("div", { className: "field", key: item },
            react_1.default.createElement("div", { className: "ui checkbox" },
                ...
                react_1.default.createElement("label", { htmlFor: id + "-" + escape(item) }, transform ? transform(item) : item)))); })) : (react_1.default.createElement("select", { className: "ui selection dropdown", disabled: disabled, id: id, name: name, onChange: function (event) {
